...
public class ReceiverModuleBelgium extends TestBase {

	randomNumberGenarator RndmNmb = new randomNumberGenarator();
	randomMailGenerator RndmMail = new randomMailGenerator();

	@Test
	public void ReceiverModuleBelgiumTest() throws InterruptedException {
		...
		// RESIDENCE COUNTRY
		DropDownSelect.DropdownListSelect(ReceiverModule.getResidenceCountry(), "Belgium");

		// RESIDENCE CITY
		ReceiverModule.getResidenceCity().sendKeys("Gent");
		Thread.sleep(5000);
