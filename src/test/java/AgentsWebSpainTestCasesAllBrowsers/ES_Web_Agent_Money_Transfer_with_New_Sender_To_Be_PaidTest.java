...
public class ES_Web_Agent_Money_Transfer_with_New_Sender_To_Be_PaidTest extends TestBase {
	...
	public void ES_Web_Agent_Money_Transfer_with_New_Customer_And_Transfer_To_Be_Paid_Test() throws Exception {
		...
		String parendId = it.next(); // Goes to index 0
		String childId = it.next(); // Goes to index 1
		...
		// AMOUTH TO BE PAID
		minidriver.findElement(By.id("ctl00_PagesContainer_txtAmount")).sendKeys("3");

		// SEARCH
		minidriver.findElement(By.id("ctl00_PagesContainer_btnSearch")).click();

		// SWITCH TO TRANSFERS DETAIL WINDOW
		Set<String> windows_1 = driver.getWindowHandles(); // [parentid, childid, subchildid]
		Iterator<String> it_1 = windows_1.iterator();

		String parendId_1 = it_1.next(); // Goes to index 0
		String childId_1 = it_1.next(); // Goes to index 1
		...
		// Come back to the parent window
		driver.switchTo().window(parendId_1);
