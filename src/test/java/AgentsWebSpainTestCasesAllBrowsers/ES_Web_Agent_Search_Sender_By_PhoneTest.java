...
public class ES_Web_Agent_Search_Sender_By_PhoneTest extends TestBase {
	...
	public void BE_Web_Agent_Search_Sender_By_Phone_Test() throws InterruptedException {
		...
		SenderModule.getExistentCustomerTxtSearch().sendKeys("+614324323232");
		...
		// CONTROL
		String ActualPhone = "+614324323232";
