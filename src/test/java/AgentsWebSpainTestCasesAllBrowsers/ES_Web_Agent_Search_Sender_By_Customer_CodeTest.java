...
public class ES_Web_Agent_Search_Sender_By_Customer_CodeTest extends TestBase {

	@Test
	@Severity(SeverityLevel.MINOR)
	public void ES_Web_Agent_Search_Sender_By_Customer_Code_Test() throws InterruptedException {
		...
		SenderModule.getExistentCustomerTxtSearch().sendKeys("2531881");
